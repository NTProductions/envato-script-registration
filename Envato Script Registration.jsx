...
/////////// TO DO
// -Improve instructions window
// -Remember if user already registered
// -More obscurity and things in a connected jsxbin file

registerButton.onClick = function() {
    if(edittext.text.indexOf(" ") == -1) {
        if(envatoLicenseCheck(edittext.text) != null) {
...
function envatoLicenseCheck(purchaseCode) {
    var envatoResponse = "";
    try {
      envatoResponse = system.callSystem('curl -H "Authorization: Bearer eunhDE5HOTODYRxMtqay4HPNymwjPjQq" https://api.envato.com/v1/market/private/user/verify-purchase:'+purchaseCode+'.json');
    } catch (e) {
      envatoResponse = "";
      return null;
